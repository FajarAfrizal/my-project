    ...
    <div class="container d-flex justify-content-center">
        <div class="card card-form mx-md-5 mx-0 my-5">
            <div class="card-body px-2 bg-white shadow">
                ...
                <form action="{{ route('store') }}" data-aos="fade-up" data-aos-delay="400" class="form"
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" placeholder="Masukan Nama Anda" name="nama" id="nama"
                                    class="form-control mb-2" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="ml-2 mb-2"><b>Jurusan</b></label>
                                <select name="jurusan" class="form-control w-100 mb-2">
                                    <option hidden disabled selected>-- Masukan Jurusan Anda --</option>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="number" class="form-control mb-2" placeholder="Angkatan"
                            ...
                            <div class="row">
                                <div class="form-goup col-md-12">
                                    ...
                                    <select name="status_bekerja" class="form-control mb-2" onchange='checkvalue(this.value)'>
                                        <option hidden disabled selected>--Pilih Status bekerja--</option>
                            ...
                            <div class="row" id="bekerja1"  style="display: none">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" placeholder="Bekerja di" name="bekerja" id="bekerja"
                                        class="form-control mb-2">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="instagram" class="mb-2"><b>Akun Instagram</b></label>
                                <input type="text" placeholder="Masukan Link Instagram Anda" name="instagram" id="instagram"
                                    class="form-control mb-2" >
                            </div>
                            <div class="form-group col-md-12">
                                <label for="facebook" class="mb-2"><b>Akun Facebook</b></label>
                                <input type="text" placeholder="Masukan Link facebook Anda" name="facebook" id="facebook"
                                    class="form-control mb-2" >
                            </div>
                            <div class="form-group col-md-12">
                                <label for="linkedlin" class="mb-2"><b> Akun Linkedlin</b></label>
                                <input type="text" placeholder="Masukan Link linkedlin Anda" name="linkedlin" id="linkedlin"
                                    class="form-control mb-2" >
                            </div>
                            <div class="form-group col-md-12">
                                <label for="twitter" class="mb-2"><b>Akun Twitter</b></label>
                                <input type="text" placeholder="Masukan twitter Anda" name="twitter" id="twitter"
                                    class="form-control mb-2" >
                            </div>
                            ...
                            <button type="submit" class="form-control mb-2 bg-primary" style="color: white" >Submit</button>
                        </div>
                    </div>
